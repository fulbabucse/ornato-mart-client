          ...
          <div className="px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <Link
                  to="/"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-baseColor/30 hover:text-primaryColor hover:border-primaryColor sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <FaFacebookF />
                </Link>
                <Link
